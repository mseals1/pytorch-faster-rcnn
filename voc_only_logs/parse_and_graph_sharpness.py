...
# print(ylabels.shape)
r_sh = np.array([i * 34 for i in range(0, 12)]).round(decimals=2)
# exit()
...
plt.title('Effect of the Sharpness on Model Performance by class', fontsize=28)
plt.axis(([0, 13, 0, 1]))
plt.xticks(xs, r_sh, fontsize=14)
